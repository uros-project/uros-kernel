...
public class ResourceResolverTest {
  ...
  void testResolveResourceSuccess() {
    ...
    ResourceInstance instance =
        instanceManager.createResourceInstance(resourceType.getId(), resourceType.getName(), data);
  ...
  void testResolveResourceTypeNotFound() {
    ...
    ResourceInstance instance =
        instanceManager.createResourceInstance("non-existent-type-id", "TestType", data);
  ...
  void testResolveMultipleResources() {
    ...
    ResourceInstance instance1 =
        instanceManager.createResourceInstance(resourceType.getId(), resourceType.getName(), data1);
    ResourceInstance instance2 =
        instanceManager.createResourceInstance(resourceType.getId(), resourceType.getName(), data2);
