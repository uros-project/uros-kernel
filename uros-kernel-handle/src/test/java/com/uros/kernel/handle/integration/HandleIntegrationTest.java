...
public class HandleIntegrationTest {
  ...
  void testCompleteWorkflow() {
    ...
    ResourceInstance updatedInstance =
        kernelHandle.updateResourceInstance(userInstance.getId(), updatedData);
              ...
              () -> {
                try {
                  ...
                  ResourceInstance instance =
                      kernelHandle.createResourceInstance("ConcurrentType", data);
