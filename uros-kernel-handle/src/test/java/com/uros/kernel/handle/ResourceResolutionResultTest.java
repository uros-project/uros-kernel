...
public class ResourceResolutionResultTest {
  ...
  void testMultipleResults() {
    ...
    ResourceResolutionResult successResult =
        ResourceResolutionResult.success("id1", instance1, type1);
    ...
    // 测试类型未找到结果
    ResourceResolutionResult typeNotFoundResult =
        ResourceResolutionResult.typeNotFound("id3", "type3-id");
