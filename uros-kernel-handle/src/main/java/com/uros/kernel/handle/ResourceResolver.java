...
public class ResourceResolver {
  ...
  public ResourceResolver(
      ResourceTypeRegistry typeRegistry, ResourceInstanceManager instanceManager) {
    this.typeRegistry = typeRegistry;
    this.instanceManager = instanceManager;
  }

  /**
   * 根据资源ID解析资源 这是核心服务，提供基于资源唯一编号的资源解析
   *
  ...
  public CompleteResourceInfo getCompleteResourceInfo(String resourceId) {
    ...
    return new CompleteResourceInfo(
        result.getInstance(), result.getType(), result.getType().getSchema());
  }
