...
/** 资源类型 REST API 控制器 提供资源类型管理的所有 REST 接口 */
@RestController
...
public class ResourceTypeController {
  ...
  /** 注册资源类型 POST /api/resource-types */
  @PostMapping
  public ResponseEntity<ApiResponse<ResourceType>> registerResourceType(
      @RequestBody ResourceTypeRequest request) {
    try {
      ResourceType resourceType =
          kernelHandle.registerResourceType(
              request.getName(), request.getDescription(), request.getSchema());
  ...
  /** 根据ID查询资源类型 GET /api/resource-types/{typeId} */
  @GetMapping("/{typeId}")
  public ResponseEntity<ApiResponse<ResourceType>> getResourceTypeById(
  ...
  /** 根据名称查询资源类型 GET /api/resource-types/name/{name} */
  @GetMapping("/name/{name}")
  public ResponseEntity<ApiResponse<ResourceType>> getResourceTypeByName(
  ...
  /** 获取所有资源类型 GET /api/resource-types */
  @GetMapping
  ...
  /** 更新资源类型 PUT /api/resource-types/{typeId} */
  @PutMapping("/{typeId}")
  public ResponseEntity<ApiResponse<ResourceType>> updateResourceType(
      @PathVariable String typeId, @RequestBody ResourceTypeUpdateRequest request) {
    try {
      ResourceType resourceType = kernelHandle.getResourceTypeById(typeId);
  ...
  /** 删除资源类型 DELETE /api/resource-types/{typeId} */
  ...
  /** 检查资源类型是否存在 GET /api/resource-types/{typeId}/exists */
  ...
  /** 获取资源类型数量 GET /api/resource-types/count */
  @GetMapping("/count")
