...
public class ResourceResolutionResult {
  ...
  private ResourceResolutionResult(
      String resourceId,
      boolean success,
  ...
  /** 创建成功的结果 */
  public static ResourceResolutionResult success(
      String resourceId, ResourceInstance instance, ResourceType type) {
  ...
  public static ResourceResolutionResult notFound(String resourceId) {
    return new ResourceResolutionResult(
        resourceId, false, null, null, "Resource with ID '" + resourceId + "' not found");
  }
